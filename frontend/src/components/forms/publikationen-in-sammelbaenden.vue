<script setup>
    ...
    import schema from '@schemas/new/publikationen-in-sammelbaenden.json';
    ...
    async function submit_form() {
        ...
        try {
            const response = await fetch(`${API_URL}/api/new-activity/publikationen-in-sammelbaenden/${userID.value}`, {
                method: 'POST',
                headers: {
