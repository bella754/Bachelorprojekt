<script setup>
    ...
    import schema from '@schemas/new/einrichtung-eines-internationalen-studiengangs.json';
    ...
    async function submit_form() {
        ...
        try {
            const response = await fetch(`${API_URL}/api/new-activity/einrichtung-eines-internationalen-studiengangs/${userID.value}`, {
                method: 'POST',
                headers: {
