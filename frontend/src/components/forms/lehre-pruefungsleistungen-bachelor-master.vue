<script setup>
    ...
    import schema from '@schemas/new/lehre-pruefungsleistungen-bachelor-master.json';
    ...
    async function submit_form() {
        ...
        try {
            const response = await fetch('/api/new-activity/lehre-pruefungsleistungen-bachelor-master', {
                method: 'POST',
                headers: {
    ...
    <div class="form_container">
        ...
        <form class="form">
            <div v-for="(field, key) in schemaProperties" :key="key">
                ...
                <input v-else-if="field.type === 'integer'" step="1" min="0" pattern="\\d*" placeholder="Nur ganze Zahlen" class="form_input" :id="key" v-model="formData[key]" type="number" @keydown="preventNonInteger"/>
