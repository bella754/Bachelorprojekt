<script setup>
    ...
    import schema from '@schemas/new/vortrag-auf-tagungen-konferenzen.json';
    ...
    async function submit_form() {
        ...
        try {
            const response = await fetch(`${API_URL}/api/new-activity/vortrag-auf-tagungen-konferenzen/${userID.value}`, {
                method: 'POST',
                headers: {
