<script setup>
    ...
    import schema from '@schemas/new/begutachtungs-und-beratungsfunktionen.json';
    ...
    async function submit_form() {
        ...
        try {
            const response = await fetch(`${API_URL}/api/new-activity/begutachtungs-und-beratungsfunktionen/${userID.value}`, {
                method: 'POST',
                headers: {
