<script setup>
    ...
    import fundingSchema from '@schemas/funding.json';

    const formData = ref({});
    const schema = fundingSchema.properties;
    ...
    async function submit_form() {
        ...
        try {
            const response = await fetch('/api/new-activity/funding', {
                method: 'POST',
                headers: {
...
<template>
    ...
    <div class="form_container">
        <h1 class="form_headline">Spendeninfo erstellen</h1>
        <form class="form">
